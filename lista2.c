...
float salarioBruto, valorPrestacao, limitePrestacao;
    ...
    if (valorPrestacao <= limitePrestacao) {
        ...
        printf("Emprestimo nao pode ser concedido. O valor da prestacao ultrapassa o limite de 30%% do salario.\n");
    }
...
void questao07() {
    ...
    if (num >= 20 & num <= 50) {
        printf("Esta entre 20 e 50.\n");
    } else {
        printf("Nao esta entre 20 e 50.\n");
    }
...
//9. Faça um programa que permita entrar com o ano de nascimento da pessoa e com ano
...
void questao09() {
    ...
    if (anonascimento >0 & anonascimento < 2024) {
        printf("Sua Idade é:\n",idade);
    } else {
